...
A collection of CodeForces problem solutions written in Java, with full JUnit 5 unit tests mirroring the official example sets.

**Build tool:** Maven &nbsp;|&nbsp; **Language:** Java &nbsp;|&nbsp; **Test framework:** JUnit 5

---

## Table of Contents

1. [4A Watermelon](https://codeforces.com/problemset/problem/4/A) — [Main Class File](src/main/java/com/polybit/Watermelon_4A.java) · [Test File](src/test/java/com/polybit/Watermelon_4ATest.java)
